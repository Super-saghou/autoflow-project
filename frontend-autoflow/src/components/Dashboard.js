      ...
      <div style={{ display: 'flex', flex: 1 }}>
        ...
        <div className="main-content" style={{ flex: 1 }}>
          ...
          {activeSection === 'automation' && (
            <div><h2 className="section-header">Automation</h2><div className="config-section"><h3>Playbook Library</h3><div className="config-subsection"><h4 style={{ color: '#1e3a8a', fontWeight: '700' }}>Create VLAN</h4><form className="login-form"><div className="form-group"><label>VLAN ID:</label><input type="text" className="form-input" placeholder="Ex: 10" /></div><div className="form-group"><label>Name:</label><input type="text" className="form-input" placeholder="Ex: VLAN_10" /></div><button type="submit" className="login-btn">Execute</button></form></div></div></div>
          )}
